...
//----------------------------------------------------
   ...
   M0P_SYSCTRL->PLL_CR_f.DIVN = 0x04;       //4*12 = 48M
   M0P_SYSCTRL->PLL_CR_f.FRSEL = 0x02;      // osc in 12M-20M
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
static volatile sdt_int16u tick_millsecond;
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//------------------------------------------------------------------------------
    ...
    M0P_GPIO->PA11_SEL = 0;
    M0P_GPIO->PADIR_f.PA11 = 0;  //output
    M0P_GPIO->PAOUT_f.PA11 = 0;  
    #endif
